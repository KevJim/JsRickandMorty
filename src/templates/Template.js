...
const Template = async () => {
  const data = await getData(Math.floor(Math.random()*(20+1)));
  const view = `
    <div class="About">
      <div class="card">
        ...
        <div class="card_social">
          <a href="https://twitter.com/Jiokso">
            <img src="${twitter}" />
          </a>
          <a href="https://github.com/KevJim">
            <img src="${github}" />
          </a>
          <a href="https://www.instagram.com/kevjimoso/">
            <img src="${instagram}" />
          </a>
        </div>
      </div>
